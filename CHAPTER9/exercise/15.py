...
ax1.plot_surface(x2, y2, butter_filter, cmap='RdPu'), plt.title("butter_filter")

'''titles = ["input image", "butter_lowpassed_image", "gauss_lowpassed_image", "input spectrum", "gauss_lowpassed_spectrum", "butter_lowpassed_spectrum"]
